...
function classList(props) {
  ...
  var classes =
    ...
    _defineProperty2(_classes, 'fa-swap-opacity', props.swapOpacity),
    _classes);
...
function convert(createElement2, element) {
  ...
  mixins.attrs['style'] = _objectSpread22(
    _objectSpread22({}, mixins.attrs['style']),
    existingStyle,
  );
  return createElement2.apply(
    void 0,
    [
      element.tag,
      _objectSpread22(_objectSpread22({}, mixins.attrs), remaining),
    ].concat(_toConsumableArray2(children)),
  );
}
...
var FontAwesomeIcon = import_react.default.forwardRef(function (props, ref) {
  ...
  var classes = objectWithKey(
    'classes',
    [].concat(
      _toConsumableArray2(classList(allProps)),
      _toConsumableArray2(className.split(' ')),
    ),
  );
  var transform = objectWithKey(
    'transform',
    typeof allProps.transform === 'string'
      ? parse$1.transform(allProps.transform)
      : allProps.transform,
  );
  ...
  var renderedIcon = icon2(
    ...
    _objectSpread22(
      _objectSpread22(
        _objectSpread22(_objectSpread22({}, classes), transform),
        mask,
      ),
      {},
      {
...
FontAwesomeIcon.propTypes = {
  ...
  transform: import_prop_types.default.oneOfType([
    import_prop_types.default.string,
    import_prop_types.default.object,
  ]),
