import { require_prop_types } from './chunk-O63ZRILJ.js';
import { require_react } from './chunk-QY3QVPNU.js';
...
var configHandlers = function (
  ...
  return configHandlers2(
    ...
    function (handlerLookup, key) {
      return function (e) {
        var _a;
        return (_a = handlerLookup(key)) === null || _a === void 0
          ? void 0
          : _a(e, editor);
      };
    },
  ...
  var deleteScripts = function () {
    ...
    for (var _i = 0, _b = Object.values(lookup); _i < _b.length; _i++) {
      ...
      if (scriptTag != null && scriptTag.tagName === 'SCRIPT') {
        (_a = scriptTag.parentNode) === null || _a === void 0
          ? void 0
          : _a.removeChild(scriptTag);
      }
    }
    lookup = {};
  };
  ...
  (function (_super) {
    ...
    function Editor2(props) {
      ...
      _this.handleBeforeInput = function (_evt) {
        if (
          ...
          _this.props.value === _this.currentContent &&
          _this.editor
        ) {
      ...
      _this.handleEditorChange = function (_evt) {
        ...
        if (editor && editor.initialized) {
          ...
          if (
            _this.props.value !== void 0 &&
            _this.props.value !== newContent &&
            _this.props.rollback !== false
          ) {
            if (!_this.rollbackTimer) {
              _this.rollbackTimer = window.setTimeout(
                _this.rollbackChange,
                typeof _this.props.rollback === 'number'
      ...
      _this.initialise = function (attempts) {
        ...
        var finalInit = __assign3(
          __assign3(
            __assign3(__assign3({}, _this.props.init), {
              selector: void 0,
              target,
              readonly: _this.props.disabled,
              inline: _this.inline,
              plugins: mergePlugins(
                (_a2 = _this.props.init) === null || _a2 === void 0
                  ? void 0
                  : _a2.plugins,
                _this.props.plugins,
              ),
              toolbar:
                (_b2 = _this.props.toolbar) !== null && _b2 !== void 0
                  ? _b2
                  : (_c2 = _this.props.init) === null || _c2 === void 0
                    ? void 0
                    : _c2.toolbar,
            }),
          ...
          ),
          {
            ...
            init_instance_callback: function (editor) {
              ...
              _this.currentContent =
                (_a3 = _this.currentContent) !== null && _a3 !== void 0
                  ? _a3
                  : editor.getContent();
              ...
              var disabled =
                (_b3 = _this.props.disabled) !== null && _b3 !== void 0
                  ? _b3
                  : false;
              setMode(_this.editor, disabled ? 'readonly' : 'design');
              if (
                _this.props.init &&
                isFunction(_this.props.init.init_instance_callback)
              ) {
      ...
      _this.inline =
        (_c =
          (_a = _this.props.inline) !== null && _a !== void 0
            ? _a
            : (_b = _this.props.init) === null || _b === void 0
              ? void 0
              : _b.inline) !== null && _c !== void 0
          ? _c
          : false;
      _this.boundHandlers = {};
      return _this;
    ...
    Object.defineProperty(Editor2.prototype, 'view', {
      get: function () {
        var _a, _b;
        return (_b =
          (_a = this.elementRef.current) === null || _a === void 0
            ? void 0
            : _a.ownerDocument.defaultView) !== null && _b !== void 0
          ? _b
          : window;
      },
      enumerable: false,
    ...
    Editor2.prototype.componentDidUpdate = function (prevProps) {
      ...
      if (this.editor) {
        ...
        if (this.editor.initialized) {
          this.currentContent =
            (_a = this.currentContent) !== null && _a !== void 0
              ? _a
          ...
          if (
            ...
            localEditor_1.undoManager.transact(function () {
              ...
              if (!_this.inline || localEditor_1.hasFocus()) {
                for (
                  var _i = 0, _a2 = [cursor, valueCursor];
                  _i < _a2.length;
                  _i++
                ) {
                  var bookmark = _a2[_i];
          ...
          if (this.props.disabled !== prevProps.disabled) {
            var disabled =
              (_b = this.props.disabled) !== null && _b !== void 0 ? _b : false;
    ...
    Editor2.prototype.componentDidMount = function () {
      ...
      if (getTinymce(this.view) !== null) {
        ...
        (_b = (_a = this.props).onScriptsLoadError) === null || _b === void 0
          ? void 0
          : _b.call(
              _a,
              new Error(
        ...
        (_c = this.elementRef.current) === null || _c === void 0
          ? void 0
          : _c.ownerDocument
      ) {
        var successHandler = function () {
          var _a2, _b2;
          (_b2 = (_a2 = _this.props).onScriptsLoad) === null || _b2 === void 0
            ? void 0
            : _b2.call(_a2);
          _this.initialise();
        };
        var errorHandler = function (err) {
          var _a2, _b2;
          (_b2 = (_a2 = _this.props).onScriptsLoadError) === null ||
          _b2 === void 0
            ? void 0
            : _b2.call(_a2, err);
        };
        ScriptLoader.loadList(
          ...
          (_e =
            (_d = this.props.scriptLoading) === null || _d === void 0
              ? void 0
              : _d.delay) !== null && _e !== void 0
            ? _e
            : 0,
          successHandler,
          errorHandler,
    ...
    Editor2.prototype.changeEvents = function () {
      ...
      var isIE =
        (_c =
          (_b =
            (_a = getTinymce(this.view)) === null || _a === void 0
              ? void 0
              : _a.Env) === null || _b === void 0
            ? void 0
            : _b.browser) === null || _c === void 0
          ? void 0
          : _c.isIE();
      return isIE
    ...
    Editor2.prototype.getScriptSources = function () {
      var _a, _b;
      var async =
        (_a = this.props.scriptLoading) === null || _a === void 0
          ? void 0
          : _a.async;
      var defer =
        (_b = this.props.scriptLoading) === null || _b === void 0
          ? void 0
          : _b.defer;
      ...
      var cloudTinyJs = 'https://cdn.tiny.cloud/1/'
        .concat(apiKey, '/tinymce/')
        .concat(channel, '/tinymce.min.js');
